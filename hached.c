...
Mix_Chunk *sound[8],*sound1[10],*sound2,*sound3;
    int done = 1,i,j=1,k,b=0,l=0, run = 0,n=-1, run1 = 0,n1=-1,vm=50,vsfx=100,po=2;
    char filename[20],filename1[20];
    SDL_Init(SDL_INIT_VIDEO | SDL_INIT_AUDIO);
int nb=0,v=0,s=500,test=-1;
float distancex,distancey;
    SDL_Surface *screen, *bg,*boat;
ennemi e1,e2,e3,e4,e5,e6,e7,e8,e9,e10,e11;
initennemi1(&e1);
initennemi1(&e3);
initennemi1(&e4);
initennemi1(&e5);
...
sound3= Mix_LoadWAV("music/j1.wav");
    ...
    while (done)
    {
         ...
         SDL_BlitSurface(bg, &map1pos, screen, NULL);
                          SDL_BlitSurface(p.hb[po], NULL, screen, &bgPos);
afficherennemi1(&e1,screen);
afficherennemi1(&e2,screen);
 deplacedt(&e1,dt);
 deplacerdrouj(&e2,&test);
animerennemi1(&e1);
animerennemi2(&e2);
updateennemi(&e1,p.PersoPos,&distancex,&dt);    
 if (s==450){
 //initennemi1(&e3);
...
if (s<=250){
//initennemi1(&e7);
afficherennemi1(&e7,screen);
 deplacedt(&e7,dt);
 animerennemi1(&e7);
  updateennemi(&e7,p.PersoPos,&distancex,&dt);    
}
if (s<=200){
//initennemi1(&e8);
afficherennemi1(&e8,screen);
 deplacedt(&e8,dt);
 animerennemi1(&e8);
  updateennemi(&e8,p.PersoPos,&distancex,&dt);    
}
if (s<=150){
//initennemi1(&e9);
afficherennemi1(&e9,screen);
 deplacedt(&e9,dt);
 animerennemi1(&e9);
  updateennemi(&e9,p.PersoPos,&distancex,&dt);    
}
if (s<=100){
//initennemi1(&e10);
afficherennemi1(&e10,screen);
 deplacedt(&e10,dt);
 animerennemi1(&e10);
  updateennemi(&e10,p.PersoPos,&distancex,&dt);    
}
if (s<=50){
//initennemi1(&e11);
afficherennemi1(&e11,screen); 
 deplacedt(&e11,dt);
 animerennemi1(&e11);
  updateennemi(&e11,p.PersoPos,&distancex,&dt);    
...
if( ((collisionBB(e1.posscreen,p.PersoPos)==0)&&e1.sprite!=NULL)||((collisionBB(e2.posscreen,p.PersoPos)==0)&&e2.sprite!=NULL)||((collisionBB(e3.posscreen,p.PersoPos)==0)&&e3.sprite!=NULL)||((collisionBB(e4.posscreen,p.PersoPos)==0)&&e4.sprite!=NULL)||((collisionBB(e5.posscreen,p.PersoPos)==0)&&e5.sprite!=NULL)||((collisionBB(e6.posscreen,p.PersoPos)==0)&&e6.sprite!=NULL)||((collisionBB(e7.posscreen,p.PersoPos)==0)&&e7.sprite!=NULL)||((collisionBB(e8.posscreen,p.PersoPos)==0)&&e8.sprite!=NULL)||((collisionBB(e9.posscreen,p.PersoPos)==0)&&e9.sprite!=NULL)||((collisionBB(e10.posscreen,p.PersoPos)==0)&&e10.sprite!=NULL)||((collisionBB(e11.posscreen,p.PersoPos)==0)&&e11.sprite!=NULL)){
 //done=1;
 SDL_Delay(100);
 p.PersoPos.x-=300;
 po--;
 ...
 //arduinoWriteData(0);
      ...
      if (((p.PersoPos.x+p.PersoPos.w<e11.posscreen.x+60)&&p.i.attack==1&&e10.sprite==NULL) ||((e11.posscreen.x+e11.posscreen.w<p.PersoPos.x+60)&&p.i.attack==1&&e10.sprite==NULL) ||((p.PersoPos.y+p.PersoPos.h<e11.posscreen.y+19)&&p.i.attack==1&&e10.sprite==NULL)||((e11.posscreen.y+e11.posscreen.h<p.PersoPos.y+15)&&p.i.attack==1&&e10.sprite==NULL))
e11.sprite=NULL;
if (((p.PersoPos.x+p.PersoPos.w<e10.posscreen.x+60)&&p.i.attack==1&&e9.sprite==NULL) ||((e10.posscreen.x+e10.posscreen.w<p.PersoPos.x+60)&&p.i.attack==1&&e9.sprite==NULL) ||((p.PersoPos.y+p.PersoPos.h<e10.posscreen.y+19)&&p.i.attack==1&&e9.sprite==NULL)||((e10.posscreen.y+e10.posscreen.h<p.PersoPos.y+15)&&p.i.attack==1&&e9.sprite==NULL))
e10.sprite=NULL;
if (((p.PersoPos.x+p.PersoPos.w<e9.posscreen.x+60)&&p.i.attack==1&&e8.sprite==NULL) ||((e9.posscreen.x+e9.posscreen.w<p.PersoPos.x+60)&&p.i.attack==1&&e8.sprite==NULL) ||((p.PersoPos.y+p.PersoPos.h<e9.posscreen.y+19)&&p.i.attack==1&&e8.sprite==NULL)||((e9.posscreen.y+e9.posscreen.h<p.PersoPos.y+15)&&p.i.attack==1&&e8.sprite==NULL))
e9.sprite=NULL;
if (((p.PersoPos.x+p.PersoPos.w<e8.posscreen.x+60)&&p.i.attack==1&&e7.sprite==NULL) ||((e8.posscreen.x+e8.posscreen.w<p.PersoPos.x+60)&&p.i.attack==1&&e7.sprite==NULL) ||((p.PersoPos.y+p.PersoPos.h<e8.posscreen.y+19)&&p.i.attack==1&&e7.sprite==NULL)||((e8.posscreen.y+e8.posscreen.h<p.PersoPos.y+15)&&p.i.attack==1&&e7.sprite==NULL))
e8.sprite=NULL;
if (((p.PersoPos.x+p.PersoPos.w<e7.posscreen.x+60)&&p.i.attack==1&&e6.sprite==NULL) ||((e7.posscreen.x+e7.posscreen.w<p.PersoPos.x+60)&&p.i.attack==1&&e6.sprite==NULL) ||((p.PersoPos.y+p.PersoPos.h<e7.posscreen.y+19)&&p.i.attack==1&&e6.sprite==NULL)||((e7.posscreen.y+e7.posscreen.h<p.PersoPos.y+15)&&p.i.attack==1&&e6.sprite==NULL))
e7.sprite=NULL;
